<template><div><h1 id="backdrop-filter-속성으로-배경-이미지-블러처리하기-ie대응" tabindex="-1"><a class="header-anchor" href="#backdrop-filter-속성으로-배경-이미지-블러처리하기-ie대응" aria-hidden="true">#</a> backdrop-filter 속성으로 배경 이미지 블러처리하기(IE대응)</h1>
...
<div class="language-scss ext-scss line-numbers-mode"><pre v-pre class="language-scss"><code><span class="token selector">.card </span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img  src="@source/docs/CSS/2022-12-07-backdrop-filter-속성으로-배경-이미지-블러처리하기(IE대응)/img/2.png" width="300"/>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="텍스트-영역만-블러처리" tabindex="-1"><a class="header-anchor" href="#텍스트-영역만-블러처리" aria-hidden="true">#</a> 텍스트 영역만 블러처리</h2>
