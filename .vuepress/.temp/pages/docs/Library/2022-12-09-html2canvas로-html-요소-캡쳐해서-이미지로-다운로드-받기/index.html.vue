<template><div><h1 id="html2canvas로-html-요소-캡쳐해서-이미지로-다운로드-받기" tabindex="-1"><a class="header-anchor" href="#html2canvas로-html-요소-캡쳐해서-이미지로-다운로드-받기" aria-hidden="true">#</a> html2canvas로 html 요소 캡쳐해서 이미지로 다운로드 받기</h1>
...
<div class="language-tsx ext-tsx line-numbers-mode"><pre v-pre class="language-tsx"><code><span class="token comment">// 변환된 canvas를 이미지로 다운로드 받는 함수</span>
