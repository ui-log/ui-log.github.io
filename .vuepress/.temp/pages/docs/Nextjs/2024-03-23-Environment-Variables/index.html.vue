...
</span><span class="token table-data-rows"><span class="token punctuation">|</span><span class="token table-data"> v9.4.0  </span><span class="token punctuation">|</span><span class="token table-data"> Support <span class="token code-snippet code keyword">`.env`</span> and <span class="token code-snippet code keyword">`NEXT_PUBLIC_`</span> introduced. </span><span class="token punctuation">|</span>
