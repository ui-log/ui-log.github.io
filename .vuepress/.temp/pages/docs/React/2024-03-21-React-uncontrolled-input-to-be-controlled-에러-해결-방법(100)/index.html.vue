...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>Warning: A component is changing an uncontrolled input to be controlled.
...
<img src="@source/docs/React/2024-03-21-React-uncontrolled-input-to-be-controlled-에러-해결-방법(100)/img/1.png" width="500" />
