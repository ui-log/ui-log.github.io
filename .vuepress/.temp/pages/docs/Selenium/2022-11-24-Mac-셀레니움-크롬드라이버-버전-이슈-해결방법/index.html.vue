<template><div><h1 id="셀레니움-크롬드라이버-버전-이슈-해결방법-this-version-of-chromedriver-only-supports-chrome-version" tabindex="-1"><a class="header-anchor" href="#셀레니움-크롬드라이버-버전-이슈-해결방법-this-version-of-chromedriver-only-supports-chrome-version" aria-hidden="true">#</a> 셀레니움 크롬드라이버 버전 이슈 해결방법 (This version of ChromeDriver only supports Chrome version)</h1>
...
<p>이렇게 설치가 성공적으로 됐다는 메세지가 나오면 성공이다.
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sudo mv chromedriver /usr/local/bin
