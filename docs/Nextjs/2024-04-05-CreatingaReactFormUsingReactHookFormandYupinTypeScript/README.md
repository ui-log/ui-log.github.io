...
![이미지](./img/CreatingaReactFormUsingReactHookFormandYupinTypeScript_0.png)
...
![React Hook Form과 Yup을 사용한 React에서 TypeScript로 폼 만들기](./img/CreatingaReactFormUsingReactHookFormandYupinTypeScript_7.png)