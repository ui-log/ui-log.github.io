 ...
 */
declare const includeViteOptimizeDeps: (app: App, module: string | string[]) => void;
/**
 * Add modules to Vite `ssr.noExtrnal` list
 */
declare const excludeViteOptimizeDeps: (app: App, module: string | string[]) => void;
/**
 * Add modules to Vite `ssr.noExtrnal` list
 */
declare const addViteSsrNoExternal: (app: App, module: string | string[]) => void;

export { Author, AuthorInfo, BasePageFrontMatter, BaseThemeConfig, ConvertLocaleConfig, DateDetail, DateInfo, DateOptions, HopeLang, Logger, addViteSsrNoExternal, capitalize, checkLang, compareDate, deepAssign, deepAssignReverse, encodeCDATA, encodeXML, excludeViteOptimizeDeps, getAuthor, getCategory, getDate, getLocalePaths, getLocales, getRootLang, getRootLangPath, getTag, includeViteOptimizeDeps, injectLocalizedDate, isAbsoluteUrl, isUrl, lang2Path, mergeViteConfig, noopModule, path2Lang, removeGitPlugin, showLangError, strictCapitalize, timeTransformer, useCustomDevServer, useGitPlugin };
